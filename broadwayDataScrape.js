...
const url='https://addmembers.com/rainmaker/contact.aspx?ID=6240797';
Http.open("GET", url);
Http.send();
...
Http.onreadystatechange= function(){
	if (this.readyState == 4 && this.status==200){
		...
		name=nameString.slice(nameStart,nameEnd)
		...
		number=numberString.slice(numberStart,numberEnd)
		...
		optInDate=optInString.slice(optInStart,optInEnd);
